  ...
  return (
    ...
    items-start w-full max-xl:padding-x pt-28 ">
      ...
      max-sm:text-[72px] max-sm:leading-[82] font-bold">
        ...
        <br />
        <span className="text-purple inline-block mt-3">Level One</span>
        Equipments
      </h1>
      <p className="font-montserrat text-slate-gray
      text-lg leading-8 mt-6 mb-14 sm:max-w-sm">Dive into the new era of gaming with Level One's cutting-edge equipment,
       enhancing every session with precision and style.</p>
